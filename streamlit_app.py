...
st.set_page_config(page_title='Findatana\'s portfolio' ,layout="wide",page_icon='👨‍🔬')
...
st.sidebar.write('📧: findatana@gmail.com')
pdfFileObj = open('', 'rb')
st.sidebar.download_button('download resume',pdfFileObj,file_name='findatana.pdf',mime='pdf')
